...
def plot_results(
    ...
    ax1.axvline(x=abs_changepoint, color='r', linestyle='--', linewidth=2,
                label=f'Detected Change Point (window={abs_changepoint})')
    if event_windows:
        labeled = False
        for w in event_windows:
            ax1.axvline(
                x=w, color='orange', linestyle=':', linewidth=1.5, alpha=0.8,
    ...
    ax2.axvline(x=abs_changepoint, color='r', linestyle='--', linewidth=2,
